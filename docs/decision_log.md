...
| 2026-05-24 | Enable OpenAI summaries only as an optional controlled path. | Real API calls require explicit configuration and must preserve fallback behavior, preset questions, and no raw CSV transfer. |
