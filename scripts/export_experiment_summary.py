...
This baseline report comes from the original coursework comparison group. It is kept for reproducibility and comparison, not as a paper-reproduction report.
...
This model is part of the original baseline comparison group. It is kept for reproducibility and comparison, not as a paper-reproduction model.
